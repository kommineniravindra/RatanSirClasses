export const javaMenuData = [
  ...
  //   subItems: [
  //     {
  //       name: "Importance of Java",
  //       url: "java-importance",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Applications of Java",
  //       url: "java-applications",
  //       icon: "images/java.png",
  //     },
  ...
  //     {
  //       name: "Break & Continue",
  //       url: "java-break-continue",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Nested Loops",
  //       url: "java-nested-loops",
  //       icon: "images/java.png",
  //     },
  ...
  //       url: "java-custom-exceptions",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Exception Hierarchy",
  //       url: "java-exception-hierarchy",
  //       icon: "images/java.png",
  //     },
  //   ],
  // },
  ...
  //       url: "java-thread-lifecycle",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Thread Priorities",
  //       url: "java-thread-priority",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Synchronization",
  //       url: "java-synchronization",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Inter-thread Communication",
  //       url: "java-interthread",
  //       icon: "images/java.png",
  //     },
  //   ],
  // },
  ...
  //     {
  //       name: "ServerSocket",
  //       url: "java-serversocket",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Client-Server Example",
  //       url: "java-client-server",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Datagram Sockets",
  //       url: "java-datagram",
  //       icon: "images/java.png",
  //     },
  ...
  //     {
  //       name: "JDBC Drivers",
  //       url: "java-jdbc-drivers",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Database Connection",
  //       url: "java-db-connection",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Executing Queries",
  //       url: "java-execute-queries",
  //       icon: "images/java.png",
  //     },
  //     { name: "ResultSet", url: "java-resultset", icon: "images/java.png" },
  //     {
  //       name: "PreparedStatement",
  //       url: "java-preparedstatement",
  //       icon: "images/java.png",
  //     },
  //   ],
  // },
  ...
  //       url: "java-generic-classes",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Generic Methods",
  //       url: "java-generic-methods",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Bounded Types",
  //       url: "java-bounded-types",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Type Erasure",
  //       url: "java-type-erasure",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Wildcard Types",
  ...
  //       url: "java-method-references",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Default Methods",
  //       url: "java-default-methods",
  //       icon: "images/java.png",
  //     },
  //   ],
  // },
  ...
  //     {
  //       name: "Collection Factory Methods",
  //       url: "java-collection-factory",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Private Interface Methods",
  //       url: "java-private-interface-methods",
  //       icon: "images/java.png",
  //     },
  ...
  //       url: "java-code-conventions",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Exception Handling Best Practices",
  //       url: "java-exception-best",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Effective Use of Collections",
  //       url: "java-collections-best",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Threading Best Practices",
  //       url: "java-threading-best",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Memory Management Tips",
  //       url: "java-memory",
  //       icon: "images/java.png",
  //     },
  //     {
  //       name: "Performance Optimization",
  //       url: "java-performance",
  //       icon: "images/java.png",
  //     },
  //   ],
  // },
  ...
  //     {
  //       name: "Mini Projects",
  //       url: "java-mini-projects",
  //       icon: "images/project.png",
  //     },
  //     {
  //       name: "Portfolio Projects",
  //       url: "java-portfolio-projects",
  //       icon: "images/project.png",
  //     },
  //     {
  //       name: "Java Interview Questions",
  //       url: "java-interview-basic",
  //       icon: "images/interview.png",
  //     },
  //     {
  //       name: "Advanced Interview Questions",
  //       url: "java-interview-advanced",
  //       icon: "images/interview.png",
  //     },
  //     {
  //       name: "Coding Challenges",
  //       url: "java-coding-challenges",
  //       icon: "images/interview.png",
  //     },
  //     {
  //       name: "Mock Interviews",
  //       url: "java-mock-interviews",
  //       icon: "images/interview.png",
  //     },
  //   ],
  // },
