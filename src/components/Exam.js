...
// const ExamConfig = {
//   mcqCount: 50, // <-- Change this number to set the maximum MCQs to load
//   blankCount: 50, // <-- Change this number to set the maximum Blanks to load
//   codingCount: 0, // Coding is disabled
//   mcqMarks: 1, // Marks per MCQ
//   blankMarks: 1, // Marks per Blank
//   codingMarks: 0, // Coding marks are 0
// };
// const EXAM_DURATION_MINUTES = 30; // set timmer for exam

// const languageConfig = {
//   java: { language: "java", type: "none" },
//   python: { language: "python", type: "none" },
//   javascript: { language: "javascript", type: "none" },
//   sql: { language: "sql", type: "none" },
//   html: { language: "html", type: "none" },
//   css: { language: "css", type: "none" },
//   restapi: { language: "java", type: "none" },
...
// // --- START: Question Palette Component ---
...
//   const allQuestionsData = [getSectionDetails(1), getSectionDetails(2)].filter(
//     Boolean
//   );
...
//   // 🎯 DYNAMIC CALCULATION OF MAX MARKS
//   // These variables hold the Max Possible Marks based on loaded questions.
//   const maxMcqMarks = useMemo(() => {
//       return selectedQuiz.length * ExamConfig.mcqMarks;
//   }, [selectedQuiz.length]);

//   const maxBlankMarks = useMemo(() => {
//       return selectedBlanks.length * ExamConfig.blankMarks;
//   }, [selectedBlanks.length]);
  
//   const maxTotalMarks = useMemo(() => {
//     // Summing the dynamic max marks for all sections (Coding is 0)
//     return maxMcqMarks + maxBlankMarks;
//   }, [maxMcqMarks, maxBlankMarks]);
//   // ------------------------------------------------------------------------
...
//     const totalCount = totalMCQ + totalBlank;
...
//       observer.disconnect();
//     };
//   }, [selectedQuiz, selectedBlanks, showResult, isLoading]);
...
//         // 🎯 PAYLOAD INCLUDES DYNAMIC MAX MARKS as totalMarksPossible
//         const payload = {
//           email: userEmail,
//           examCode: examCode,
//           mcqMarks: mcqTotal,
...
//           totalMarksPossible: maxTotalMarks, // Sending the dynamic total
//         };

//         const authHeaders = { headers: { Authorization: `Bearer ${token}` } };

//         try {
//           // If the exam exists, it updates the record. If it doesn't, it creates a new one.
...
//         if (userEmail) {
//           const totalMarks = mcqTotal + blanksTotal;
...
//             quiz_number: null,
//             // Use dynamic max marks for email display
//             mcq_marks: `${mcqTotal} / ${maxMcqMarks}`,
//             blanks_marks: `${blanksTotal} / ${maxBlankMarks}`,
//             coding_marks: `N/A`, 
...
//       }
//     },
//     [answers, selectedBlanks, selectedQuiz, technology, examId, maxMcqMarks, maxBlankMarks, maxTotalMarks]
//   );
...
//                     disabled={selectedBlanks.length === 0} 
//                   >
//                     Fill in the Blanks
//                   </button>
//                 </div>
...
//                     MCQ:{" "}
//                     <span>
//                       {totals.mcq} / {maxMcqMarks} 
//                     </span>
//                   </p>
//                   <p>
//                     Blanks:{" "}
//                     <span>
//                       {totals.blanks} / {maxBlankMarks}
//                     </span>
//                   </p>
//                 </div>
...
//                   Grand Total:{" "}
//                   <span>
//                     {totals.mcq + totals.blanks} / {maxTotalMarks}
//                   </span>
//                 </p>
//                 <button
