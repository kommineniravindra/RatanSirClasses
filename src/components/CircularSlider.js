    ...
    () => [
      ...
      },
      {
        ...
        features: [
          {
            title: "Components",
            desc: "Modular UI blocks.",
            icon: <FaReact />,
          },
          {
            title: "Hooks API",
            desc: "Manage state simply.",
            icon: <FaLink />,
          },
          {
            title: "Virtual DOM",
      ...
      },
      {
        ...
        color: "#c03a2b94",
        description:
          "Learn data structures and algorithms with hands-on coding.",
        icon: <FaCode />,
        features: [
          {
            title: "Arrays & Lists",
