        ...
        <div className="certificate-frame">
          <div className="certificate-content">
            ...
            <div className="cert-body-text">
              <p>
                This certifies that{" "}
                <strong className="cert-user-name">{currentUserName}</strong>
                <br />
                has successfully completed the specialized{" "}
                <strong className="cert-user-name">{courseTitle}</strong> course
                in web development, as verified by {organization}.
              </p>
            </div>
            ...
            <div className="cert-footer-details">
              ...
              <div className="cert-signature-area">
                ...
                <p className="cert-signature-name">CodePulse-R</p>
  ...
  const fetchProgress = useCallback(async () => {
    ...
    try {
      const res = await axios.get(
        `/api/contests/${userId}/course?course=${course.title}`
      );
      ...
      setCourseData(
        calculateProgressMetrics(
          { course: course.title, totalMarks: 0, contests: [] },
          maxMarksMap
        )
      );
    } finally {
    ...
    <div className="certificate-item-container">
      ...
      {isCompleted && showVisual && (
        <div className="full-certificate-display-container">
          <CertificateDisplay course={course} userName={currentUserName} />
        </div>
      )}
    </div>
  );
    ...
    return (
      <div className="certificate-page-list-container">
        <h1 className="title-white">
          <FaTrophy /> All Certificate Status
        </h1>
        <div className="certificate-list-placeholder">
          <p>
            Please **log in** to track your course progress and view your earned
            certificates.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="certificate-page-list-container">
      ...
      <p className="section-title-white">
        Review the status of all available course certificates. Certificates are
        unlocked upon achieving 100% progress.
      </p>
